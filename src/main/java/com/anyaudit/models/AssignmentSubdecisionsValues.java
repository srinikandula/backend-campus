...
@Entity
@Table(name = "assignment_subdecisions_values", indexes = {
        @Index(name = "assignment_id_index", columnList = "assignment_id"),
        @Index(name = "sub_dec_id_index", columnList = "sub_dec_id")
})
@AllArgsConstructor
@NoArgsConstructor
@Getter
@Setter
public class AssignmentSubdecisionsValues extends BaseModel {
